...
class RedirectTransactionsAgent(ToolInterface):
    ...
    args_schema: Type[BaseModel] = create_model(
        ...
        query=(
            ...
            Field(
                ...,
                description="Descricao exata do que o usuario quer. Seja bem especifico e inclua detalhes relevantes para que esse agente entenda bem o que deve ser feito, informando não apenas dados que o usuário passou mas também dados do sistem (id por exemplo), quando for relevante.",
            ),
        ),
        operation_type=(
            ...
            Field(
                ...,
                description="Informe qual o agente em especifico que deve ser selecionado dentre as opções.",
            ),
        ),
    )
