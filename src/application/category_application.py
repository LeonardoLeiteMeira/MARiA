...
class CategoryApplication:
    ...
    async def delete_category(self, category_id: UUID) -> None:
        await self._category_domain.delete(category_id)
    ...
    async def delete_macro_category(self, macro_id: UUID) -> None:
        await self._macro_category_domain.delete(macro_id)
